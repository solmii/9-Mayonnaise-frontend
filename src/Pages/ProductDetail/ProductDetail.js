        ...
        <section className="ProductDetailSite">
          <ol id="breadcrumb" class="breadcrumb">
            <li class="breadcrumb__item">
              <a class="breadcrumb__link" href="/kr/ko/skincare/">
                <span class="breadcrumb__name">스킨케어</span>
              </a>
            </li>
            <li class="breadcrumb__item">
              <a class="breadcrumb__link" href="/kr/ko/skincare/line/">
                <span class="breadcrumb__name-1">라인별</span>
              </a>
            </li>
            <li class="breadcrumb__item">
              <a class="breadcrumb__link" href="/kr/ko/skincare/line/radian-c/">
                <span class="breadcrumb__name-2">래디언-C</span>
              </a>
            </li>
          </ol>
        </section>
